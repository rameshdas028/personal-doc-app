 ...
 /**
	...
	*/
	#recordInterrupt(event) {
		...
		if (isUnknownInterrupt && (this.#interruptReplayThroughSeq == null || eventSeq != null && eventSeq <= this.#interruptReplayThroughSeq)) return;
	...
	*/
	async #reconcilePendingInterruptsFromServer() {
		...
		try {
			const state = await this.#fetchHydrationState();
			if (this.#disposed || this.#currentThreadId !== threadId || this.#submitGeneration !== generationAtFetch) return;
